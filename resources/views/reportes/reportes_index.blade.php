        ...
        <form action="{{route('reportes.recoger')}}" method="POST" mid="form-cuenta">
            ...
            <div class="card-body">
                <div class="form-group">
                    <label for="ifecha_ini " style="display:inline">Indique Fecha Inicio </label><p style="display: inline;"><em>(Formato 01/04/2021)</em></p>
                    <input type="text" class="form-control" id="ifecha_ini" placeholder="Fecha Inicio" name="fecha_ini" value="{{old('fecha_ini','01/04/2021')}}">
                </div>
                <div class="form-group">
                    <label for="ifecha_fin" style="display:inline">Indique Fecha Final </label> <p style="display: inline;"><em>(Formato 01/04/2023)</em></p>
