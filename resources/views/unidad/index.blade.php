...
@section('contenido')
    <div class="row">
        ...
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">               
            <h3>Listado de Unidades
            <a href="{{route('unidad.create')}}"><button class="btn btn-success">Nueva Unidad</button></a>             
        </div>
    </div>
    <div class="row">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-condensed table-hover">
                    ...
                    <tr>
                        ...
                        <td>{{(strtoupper($unidad->tipo_unidad))}}</td>
                        <td>{{(strtoupper($unidad->unidad->descripcion ?? ''))}}</td>
                        <td>
