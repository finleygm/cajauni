...
//hay que ver esto en la ruta de nodule_module
//Vue.component('chosen-select', require('vue-multi-select/src/components/vueMultiSelect/vue-multi-select.vue').default);
